...
3. Project documentation (CLAUDE.md, PLAN.md, PROGRESS.md) lives in raw markdown files with no structured viewer or quick-edit workflow
...
- **Project Docs Tab**: Structured viewer/editor for CLAUDE.md, PLAN.md, PROGRESS.md files with markdown rendering, section navigation, and quick editing
...
- Fallback models:
  ...
  - `anthropic/claude-sonnet-4` as secondary fallback
